...
import static ch.minecraftreunitedcollaborationteam.gradle.dev.DevConstants.CROWDIN_FORGEID;
import static ch.minecraftreunitedcollaborationteam.gradle.dev.DevConstants.CROWDIN_ZIP;
import static ch.minecraftreunitedcollaborationteam.gradle.dev.DevConstants.EXC_MODIFIERS_DIRTY;
...
public class FmlDevPlugin extends DevBasePlugin
{
    ...
    private void createMiscTasks()
    {
        ...
        ApplyS2STask task4 = makeTask("retroMapSources", ApplyS2STask.class);
        {
            ...
            task4.setExcModifiers(delayedFile(DevConstants.EXC_MODIFIERS_DIRTY));
