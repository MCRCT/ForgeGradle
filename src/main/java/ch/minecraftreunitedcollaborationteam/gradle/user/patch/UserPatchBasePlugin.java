...
import static ch.minecraftreunitedcollaborationteam.gradle.user.UserConstants.CLASSIFIER_DECOMPILED;
import static ch.minecraftreunitedcollaborationteam.gradle.user.patch.UserPatchConstants.BINARIES_JAR;
import static ch.minecraftreunitedcollaborationteam.gradle.user.patch.UserPatchConstants.BINPATCHES;
import static ch.minecraftreunitedcollaborationteam.gradle.user.patch.UserPatchConstants.CLASSIFIER_PATCHED;
import static ch.minecraftreunitedcollaborationteam.gradle.user.patch.UserPatchConstants.ECLIPSE_LOCATION;
import static ch.minecraftreunitedcollaborationteam.gradle.user.patch.UserPatchConstants.JAR_BINPATCHED;
import static ch.minecraftreunitedcollaborationteam.gradle.user.patch.UserPatchConstants.JSON;
import static ch.minecraftreunitedcollaborationteam.gradle.user.patch.UserPatchConstants.RES_DIR;
import static ch.minecraftreunitedcollaborationteam.gradle.user.patch.UserPatchConstants.START_DIR;
...
import ch.minecraftreunitedcollaborationteam.gradle.user.UserConstants;
...
import ch.minecraftreunitedcollaborationteam.gradle.tasks.user.ApplyBinPatchesTask;
import ch.minecraftreunitedcollaborationteam.gradle.user.UserBasePlugin;
import ch.minecraftreunitedcollaborationteam.gradle.user.UserConstants;
