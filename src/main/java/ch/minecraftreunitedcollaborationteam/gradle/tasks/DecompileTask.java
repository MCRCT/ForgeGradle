package ch.minecraftreunitedcollaborationteam.gradle.tasks;

import static ch.minecraftreunitedcollaborationteam.gradle.common.Constants.EXT_NAME_MC;

import ch.minecraftreunitedcollaborationteam.gradle.extrastuff.FFPatcher;
import ch.minecraftreunitedcollaborationteam.gradle.extrastuff.McpCleanup;
...
import ch.minecraftreunitedcollaborationteam.gradle.common.BaseExtension;
...
import ch.minecraftreunitedcollaborationteam.gradle.extrastuff.FFPatcher;
import ch.minecraftreunitedcollaborationteam.gradle.extrastuff.FmlCleanup;
import ch.minecraftreunitedcollaborationteam.gradle.extrastuff.GLConstantFixer;
import ch.minecraftreunitedcollaborationteam.gradle.extrastuff.McpCleanup;
import ch.minecraftreunitedcollaborationteam.gradle.patching.ContextualPatch;
import ch.minecraftreunitedcollaborationteam.gradle.patching.ContextualPatch.HunkReport;
import ch.minecraftreunitedcollaborationteam.gradle.patching.ContextualPatch.PatchReport;
import ch.minecraftreunitedcollaborationteam.gradle.patching.ContextualPatch.PatchStatus;
import ch.minecraftreunitedcollaborationteam.gradle.tasks.abstractutil.CachedTask;
