package ch.minecraftreunitedcollaborationteam.gradle.delayed;

import static ch.minecraftreunitedcollaborationteam.gradle.common.Constants.EXT_NAME_JENKINS;
...
import ch.minecraftreunitedcollaborationteam.gradle.common.JenkinsExtension;
...
public abstract class DelayedBase<V> extends Closure<V>
{
    ...
    public static String resolve(String patern, Project project, IDelayedResolver... resolvers)
    {
        ...
        BaseExtension exten = (BaseExtension)project.getExtensions().getByName(Constants.EXT_NAME_MC);
        JenkinsExtension jenk = (JenkinsExtension)project.getExtensions().getByName(Constants.EXT_NAME_JENKINS);
