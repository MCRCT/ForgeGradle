...
import ch.minecraftreunitedcollaborationteam.gradle.ZipFileTree;
import ch.minecraftreunitedcollaborationteam.gradle.ZipFileTree;
...
public class DelayedFileTree extends DelayedBase<FileTree>
{
    ...
    public FileTree resolveDelayed()
    {
        if (zipTree)
            ...
            return new FileTreeAdapter(new ZipFileTree(project.file(resolve(pattern, project, resolvers))));
        else
            return project.fileTree(resolve(pattern, project, resolvers));
    }
}
